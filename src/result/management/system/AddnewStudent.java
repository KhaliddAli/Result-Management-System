...
public class AddnewStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "BCA", "BSC", "CA" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            st.executeUpdate("insert into Students(name , roll_no, father_name, dob, course, gender) values('"+name+"','"+roll+"','"+fatherName+"','"+dob+"','"+course+"','"+gender+"')");
